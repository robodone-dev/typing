...
var keyboardHTML = '' 
            ...
            + '<td colspan="1" class="col2 key"><div class="table code049">1<span class="subkey">!</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code050">2<span class="subkey">”</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code051">3<span class="subkey">#</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code052">4<span class="subkey">$</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code053">5<span class="subkey">%</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code054">6<span class="subkey">&</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code055">7<span class="subkey">’</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code056">8<span class="subkey">（</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code057">9<span class="subkey">）</span></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code048">0</div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code189 code109 code173 code045"></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code222 code160"></div></td>'
            + '<td colspan="1" class="col2 key"><div class="table code220"></div></td>'
            + '<td colspan="1" class="col3 key"><div class="table code008"></div></td>'
            + '</tr>'
            + '<tr class="tr2">'

...
var keyboardHTML = '' 
            ...
            + '</tr>'
            + '<tr class="tr2">'
            + '<td colspan="3" class="col3 key"><div class="table code009">T</div></td>'
            ...
            + '</tr>'
            + '<tr class="tr4">'
            + '<td colspan="3" class="col3 key"><div class="table code016 code020">Shift</div></td>'
            ...
            + '</tr>'
            + '<tr class="tr5">'
            + '<td colspan="3" class="col3 key"><div class="table">Ctrl</div></td>'
